...
def generate_rapport(df, risk_df):
    ...
    anom_data = [
        ...
        ["LSTM Autoencoder", f"{n_anom_ae:,}", "3.12%"],
        ["Consensus IF + AE", "8", "—"],
    ]
...
n_anom_ae = 1092
n_anom_ae_pct = 3.12  # taux reel calcule sur sequences 24h lors du training
...
# ════════════════════════════════════
    ...
    st.caption("Note : Les modeles de prevision ont ete entraines sur SRM-001 (split 80/20 chronologique, 35,065 mesures). La simulation illustre le comportement des modeles avec les erreurs reelles observees lors du test (MAE LSTM = 4.23 kWh).")
    client_p = "SRM-001"
