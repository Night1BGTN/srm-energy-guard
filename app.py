    ...
    with cb:
        ...
        for i,tc in enumerate(type_order):
            ...
            fig_ph.update_layout(
                height=200, paper_bgcolor=BG, plot_bgcolor=BG, font=FONT,
                title=dict(text=tc.capitalize(), font=dict(size=11), x=0.5),
                xaxis=dict(tickmode="linear", dtick=4, title="Heure",
                           showgrid=False, range=[-0.5, 23.5]),
                yaxis=dict(gridcolor="#F1F5F9", title="kWh", rangemode="tozero"),
