...
def generate_rapport(df, risk_df):
    ...
    kpi_data = [
        ...
        ["Anomalies LSTM AE",    f"{n_anom_ae:,} ({n_anom_ae/n_rows*100:.2f}%)", "LSTM Autoencoder"],
    ...
    top10 = risk_df.nlargest(10,"score")[
        ["client_id","type_client","conso_moy","conso_std","score","niveau"]].copy()
    ...
    anom_data = [
        ...
        ["LSTM Autoencoder",f"{n_anom_ae:,}",f"{n_anom_ae/n_rows*100:.2f}%","Haute precision"],
        ["Consensus IF+AE","8","--","Haute confiance"],
    ]
    ...
    ft = Table([[
        ...
        Paragraph("PFE Licence 2024-2025 | UCI ElectricityLoadDiagrams", s_small),
    ]], colWidths=[9*cm, 8*cm])
